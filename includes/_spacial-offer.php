<section id="special-price">
        <div class="container">
          ...
          <div id="filter" class="button-group text-end font-balo font-16">
            <button class="btn is-checked" data-filter="*">All Brands</button>
            <button class="btn" data-filter=".Keyboard">Keyboard</button>
            <button class="btn" data-filter=".Watch">Watch</button>
            <button class="btn" data-filter=".Redmi">Mobile</button>
          </div>
